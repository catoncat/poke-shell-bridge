...
LEGACY_BACKGROUND_TIMEOUT = os.environ.get("POKE_BRIDGE_BACKGROUND_TIMEOUT")
SHELL_TIMEOUT = int(
    os.environ.get(
        "POKE_BRIDGE_SHELL_TIMEOUT",
        LEGACY_BACKGROUND_TIMEOUT or LEGACY_COMMAND_TIMEOUT or str(30 * 60),
    )
)
